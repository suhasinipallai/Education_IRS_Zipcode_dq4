...
#4735 obs , 29 variabl
irs_2014_dataset[!irs_2014_dataset$zip == 0]


| !irs_2014_dataset$zip ==99999) ]
...
irs_2014_dataset$zip <- ifelse(length(irs_2014_dataset$zip)==0, "Total", irs_2014_dataset$zip)
View(irs_2014_dataset)
